...
\item
  ...
  und in stilistisch kohärente Kurztexte überführen --- erfahrungsgemäß
...
vollständig durchgeführt. Der \texttt{auto}-Modus wird dabei als
Kontrollbedingung evaluiert, die den Maximalgewinn an Geschwindigkeit
ohne redaktionelles Korrektiv abbildet; der primäre
Evaluationsvergleich gilt dem hybriden \texttt{coop}-Modus als dem für
den Produktivbetrieb intendierten Modus.
...
redaktionellen Arbeitskontext. Für den statistischen Vergleich bei größeren Stichproben stünden
nicht-parametrische Verfahren (Cliff's Delta,
Bootstrap-Konfidenzintervalle) bereit; aufgrund der Stichprobengröße
von $n = 16$ wird auf deren Einsatz im vorliegenden Evaluationsdesign
verzichtet.
