...
\item
  ...
  Experteninterview, vgl.\ Abschnitt~\ref{anforderungsanalyse-am-beispiel-eintracht-frankfurt}).
\item
...
Die Frage verbindet eine \textbf{Realisierbarkeits-} mit einer \textbf{Qualitätsdimension}. Der erste Teil ist im Sinne des Design Science Research (Hevner et al.~2004) konstruktiv angelegt: Konzeption, Architekturentscheid und prototypische Realisierung eines produktionsfähigen Systems. Der zweite Teil ist evaluativ: die empirische Prüfung, ob das System journalistische Mindestanforderungen an Korrektheit, Tonalität und Verständlichkeit erfüllt. Die Forschungsfrage wird in Abschnitt~\ref{methodisches-vorgehen} methodisch operationalisiert und in Kapitel~\ref{evaluation} vollständig beantwortet.
...
Fußball-Liveticker), die in Kapitel~\ref{diskussion} kritisch reflektiert werden.
