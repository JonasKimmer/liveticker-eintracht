...
\item \textbf{Diversitätsmechanismen gegen Phrasenwiederholung:} 13\,\% der manuell bewerteten Einträge zeigten formelhaften Satzbau bei aufeinanderfolgenden Ereignissen gleichen Typs (vgl.\ Abschnitt~\ref{qualitative-analyse-der-generierten-texte}). Techniken wie Negative Prompting (explizites Verbot zuletzt verwendeter Formulierungen) oder eine ereignistypspezifische Varianten-Bibliothek würden diesen Befund direkt adressieren.
