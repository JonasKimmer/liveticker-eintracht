...
Das entwickelte System lässt sich gegenüber bestehenden Ansätzen der automatisierten Sportberichterstattung (Abschnitt~\ref{automatisierte-sportberichterstattung}) strukturell einordnen:
...
\item \textbf{Gegenüber vollautonomen KI-Systemen} begründen Halluzinationsrate und situative Kontextblindheit den Vorrang des \texttt{coop}-Modus; die Argumentation ist in Abschnitt~\ref{diskussion-der-betriebsmodi} ausgeführt.
