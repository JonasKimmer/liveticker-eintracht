...
Das entwickelte System lässt sich in den Stand der Technik in zwei Richtungen einordnen. Er gliedert sich in die Abgrenzung zu bestehenden Systemen (Abschnitt~\ref{abgrenzung-zu-bestehenden-systemen}) und den Beitrag zur Forschung (Abschnitt~\ref{beitrag-zur-forschung}).
...
Die Evaluation in Kapitel~\ref{evaluation} hat systematisch sowohl die Stärken als auch die verbleibenden Grenzen des Systems dokumentiert. Er gliedert sich in die methodische Einordnung (Abschnitt~\ref{methodische-einordnung}), die technische Einordnung (Abschnitt~\ref{technische-einordnung}) und die inhaltliche Reflexion (Abschnitt~\ref{inhaltliche-reflexion}).
...
Der Einsatz KI-generierter Texte im Sportjournalismus berührt normative Fragen, die über die technische Systemgestaltung hinausgehen. Er gliedert sich in die ethische Einordnung (Abschnitt~\ref{ethische-einordnung}) und die regulatorischen Anforderungen (Abschnitt~\ref{regulatorische-anforderungen}).
