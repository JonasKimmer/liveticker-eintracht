...
Die 17 n8n-Workflows sind ausschließlich manuell verifiziert. Ihr Ausfall oder eine Fehlkonfiguration wäre durch die bestehende Testinfrastruktur nicht detektierbar. Die lokale Betrieb der n8n-Instanz mit \texttt{ngrok}-Tunnel (vgl. Abschnitt~\ref{deployment-konzept}) ist im Produktivbetrieb nicht vertretbar und erfordert ein Cloud-Hosting.
