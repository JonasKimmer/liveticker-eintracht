...
\chapter[Interviewleitfaden]{Interviewleitfaden: Experteninterview Digitalverantwortlicher Eintracht Frankfurt}\label{interviewleitfaden-experteninterview-sportredakteur-eintracht-frankfurt}

\section{Ziel}\label{ziel}

Qualitative Validierung der in Kapitel 2 hergeleiteten Anforderungen
sowie Bewertung des entwickelten Systems aus Sicht des Praxispartners
(Abschnitt~\ref{experteninterview-auswertung}).
...
in einem konsistenten Stil schreiben? Gibt es einen Styleguide? Falls ja, wie lautet dieser (wenn möglich)?
...
überhaupt erwünscht? Denken Sie sich im Vorfeld schon Formulierungen aus oder kommen alle spontan?
...
\textbf{IF8:} Wäre es Ihrer Meinung nach möglich, die Qualität der
KI-generierten Ticker-Texte ähnlich zu manuell verfassten Texten zu
bekommen -- mit guten Prompts, für Standardevents,
Vorberichterstattungen und Spielphasenänderungen?
...
\textbf{IF10:} Ist der Coop-Modus (also KI-Entwurf mit redaktioneller
Freigabe) ein realistischer Kompromiss zwischen Zeitersparnis und
Qualitätskontrolle?

\textbf{IF10a:} Wie bewerten Sie die Benutzeroberfläche des Systems --
ist das Layout intuitiv, und würden Sie die Steuerung im Live-Betrieb
als praktikabel einschätzen?

\textbf{IF10b:} Wie bewerten Sie das Gesamtkonzept des Systems? Was
überzeugt Sie, was würden Sie grundlegend anders lösen?

\textbf{IF11:} Welche konkreten Features fehlen grundsätzlich für einen
produktiven Einsatz?

\textbf{IF12:} Haben Sie das Gefühl, dass das System aus echten
...
\textbf{IF13:} Könnten Sie sich vorstellen, KI-generierte Ticker im
Regelbetrieb zu nutzen?

\textbf{IF13a:} Sollten KI-generierte Ticker-Einträge für Leser als
...
\textbf{IF14:} Haben Sie noch Anmerkungen, Fragen oder Aspekte, die im
...
\chapter{Interviewtranskript}\label{interviewtranskript}

Geführt am 22.~Mai~2026 mit dem Digitalverantwortlichen Eintracht Frankfurt. Fragen entsprechen dem Leitfaden in Anhang~\ref{interviewleitfaden-experteninterview-sportredakteur-eintracht-frankfurt}. Antworten kursiv. Fragen ohne Antwort (\emph{nicht gestellt}) betrafen den Live-Demo-Block, der im Rahmen dieses Interviews nicht durchgeführt wurde.
...
\textit{Englisch wäre sinnvoll. Problem bei automatisierter Übersetzung durch KI: klassischer hessischer umgangssprachlicher Wortschatz bzw.\ Fußball-typische Begriffe oder künstlich langgezogene Worte wie zum Beispiel „Toooooooooooor" oder „Jaaaaaaaa".}
