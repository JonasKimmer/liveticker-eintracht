...
Geführt am 22.~Mai~2026 mit dem Senior Manager Redaktion und Digital Media bei Eintracht Frankfurt. Strukturiertes Leitfadeninterview mit offenen Fragen, qualitative Validierung der in Kapitel~2 hergeleiteten Anforderungen sowie Bewertung des Systems aus Sicht des Praxispartners (Abschnitt~\ref{experteninterview-auswertung}). Antworten kursiv. Fragen ohne Antwort (\emph{nicht gestellt}) betrafen den Live-Demo-Block (Block~3), der im Rahmen dieses Interviews nicht durchgeführt wurde.
