...
% Disable babel's active " inside code blocks to prevent conflicts (e.g. in erDiagram)
...
% Pandoc token commands – NormalTok is the only one used; define others as no-ops for safety
