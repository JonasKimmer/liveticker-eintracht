...
% Disable babel's active " inside code blocks to prevent conflicts (e.g. erDiagram)
...
% Highlighting uses Verbatim with commandchars so \NormalTok{} etc. are processed correctly
