...
\subsection{8.1.1 Technische Ergebnisse}\label{technische-ergebnisse}
...
\subsection{8.1.2 KI-Textgenerierung}\label{ki-textgenerierung}
...
\subsection{8.1.3 Systemarchitektur und
...
\subsection{8.2.1 Zeitliche Dimension: Reduktion der
...
\subsection{8.2.2 Qualitative Dimension: Journalistische
...
\subsection{8.2.3 Synthese}\label{synthese}
...
\subsection{8.3.2 Mittelfristige
