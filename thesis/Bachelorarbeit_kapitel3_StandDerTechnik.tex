...
\section{Synthese der Technologieentscheidungen}\label{synthese-technologische-konsequenzen-fuxfcr-das-systemdesign}
...
\midrule
Operativer Zeitdruck (Kap.~\ref{redaktioneller-aufwand-bei-livetickern}) & LLM-gestützte Textgenerierung + Few-Shot-Prompting (Abschnitte~\ref{large-language-models}--\ref{prompt-engineering}); hybrides NLG-Design mit menschlicher Kontrollinstanz (Kap.~\ref{automatisierte-sportberichterstattung}) \\
\addlinespace
