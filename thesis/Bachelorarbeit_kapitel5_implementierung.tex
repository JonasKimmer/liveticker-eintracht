...
Deduplizierungs-Check per Event. Das Status-Enum wird als nicht-nativ gespeichert (\texttt{native\_enum=False}), damit Migrationen ohne PostgreSQL-seitige Enum-Typ-Änderungen auskommen, da solche Änderungen sonst eine exklusive Tabellensperre erfordern würden.
