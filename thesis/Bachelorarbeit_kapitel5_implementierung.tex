...
Der \texttt{ticker\_service} delegiert die eigentliche Textgenerierung an den \texttt{LLMService}, der als single-class-Implementierung, die beim
...
Ergänzend sind zwei Aspekte des Statusmodells hervorzuheben:
