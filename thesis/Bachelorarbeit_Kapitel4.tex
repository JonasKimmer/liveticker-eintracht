...
\subsection{4.1.1 Kommunikations- und
...
\subsection{4.1.2 Partner-Team-Konzept und
...
\subsection{4.2.1 Framework-Wahl: FastAPI}\label{framework-wahl-fastapi}
...
\subsection{4.2.2 Interne Struktur und
...
\subsection{4.2.3 API-Design und
...
\subsection{4.2.4 Asynchronität, Nebenläufigkeit und
...
\subsection{4.2.5 Fehlerbehandlung, Robustheit und
...
\subsection{4.2.6 Sicherheitskonzept}\label{sicherheitskonzept}
...
\subsection{4.3.2 Status-Lifecycle der
...
\subsection{4.3.3 Die drei Betriebsmodi}\label{die-drei-betriebsmodi}
...
\subsection{4.3.4 Integrität, Idempotenz und
...
\subsection{4.4.1 Workflow-Klassen und
...
\subsection{4.4.2 Workflow-Grenzen und projektspezifische
...
\subsection{4.5.3 Stilprofile und
...
\subsection{4.5.4 Mehrsprachigkeit}\label{mehrsprachigkeit}
...
\subsection{4.6.1 Architekturprinzipien}\label{architekturprinzipien}
...
\subsection{4.6.3 Dreispalten-Layout und
...
\subsection{4.6.4 Moduslogik und
...
\subsection{4.6.5 Kommunikationsmuster im
...
\subsection{4.7.1 Horizontale Skalierung des
...
\subsection{4.7.2 Erweiterung um neue
...
\subsection{4.7.3 Erweiterung um neue
...
\subsection{4.7.4 Deployment-Architektur}\label{deployment-architektur}
