...
\caption{Dreischichtige Systemarchitektur mit externen Diensten, Automatisierungs-, Anwendungs- und Präsentationsschicht.}
...
\caption{Kommunikationsfluss zwischen Frontend, Backend, n8n und externen APIs: Frontend delegiert Datenbeschaffung an n8n bei fehlenden Daten (read-first-Prinzip).}
...
\centering
\DiagramDataModel
\caption{Logisches Entityrelationship-Modell: Zentrale Entitäten (Match, Event, Ticker, Media) und ihre Kardinalitäten.}
\label{fig:data-model}
\end{figure}

Die einzelnen Modelle werden in Kapitel 5.2.2 detailliert dokumentiert.
...
\centering
\DiagramTickerStates
\caption{Ticker-Entry-Zustandsübergänge: draft → published → archived, mit möglicher Rückstufung zu draft für Re-Trigger und terminalem rejected-Zustand.}
\label{fig:ticker-states}
\end{figure}
...
\caption{Prompt-Engineering-Pipeline: Modularisierte Eingaben (Ereignistyp, Fakten, Kontext, Few-Shot-Beispiele, Regeln) speisen in den System-Prompt, der das LLM mit Temperature 0.3 den finalen Ticker-Text generiert.}
