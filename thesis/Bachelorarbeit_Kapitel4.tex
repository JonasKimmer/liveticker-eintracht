...
\NormalTok{        N8N["n8n\textbackslash{}n15 Workflows"]}
\NormalTok{    end}
...
\subsubsection{Kommunikations- und
...
\subsubsection{Partner-Team-Konzept und
...
\subsubsection{Framework-Wahl: FastAPI}\label{framework-wahl-fastapi}
...
\subsubsection{Interne Struktur und
...
\subsubsection{Asynchronität, Nebenläufigkeit und
...
\subsubsection{Fehlerbehandlung, Robustheit und
...
\subsubsection{Sicherheitskonzept}\label{sicherheitskonzept}
...
\subsubsection{Schemadesign-Prinzipien}\label{schemadesign-prinzipien}
...
\subsubsection{Status-Lifecycle der
...
\subsubsection{Die drei Betriebsmodi}\label{die-drei-betriebsmodi}
...
\subsubsection{Integrität, Idempotenz und
...
\subsubsection{Workflow-Klassen und
...
\subsubsection{Workflow-Grenzen und projektspezifische
...
\subsubsection{Multi-Provider-Architektur}\label{multi-provider-architektur}
...
\subsubsection{Prompt-Engineering-Strategie}\label{prompt-engineering-strategie}
...
\item
  \textbf{\texttt{euphorisch}}: situationsadaptiver Fan-Stil aus
  Eintracht-Perspektive --- euphorisch bei eigenen Toren, frustriert bei
  Gegentoren, kritisch bei hohem Rückstand, stolz bei Führung. Die
  Emotion passt sich also der Spielsituation an, statt durchgängig
  positiv zu sein.
\item
...
vereinsgebundene Stilprägung betrieben werden. Das Backend setzt für
\texttt{ef\_whitelabel}-Instanzen automatisch den Stil von
\texttt{neutral} auf \texttt{euphorisch} hoch, sodass Eintracht-Spiele
konsistent den Fan-Stil erhalten --- unabhängig davon, welchen Stil der
aufrufende Workflow übergibt.
...
\subsubsection{Architekturprinzipien}\label{architekturprinzipien}
...
\subsubsection{Dreispalten-Layout und
...
\subsubsection{Kommunikationsmuster im
...
\subsubsection{Horizontale Skalierung des
...
\subsubsection{Erweiterung um neue
...
\subsubsection{Deployment-Architektur}\label{deployment-architektur}
