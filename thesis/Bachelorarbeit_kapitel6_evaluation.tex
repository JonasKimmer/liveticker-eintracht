...
Das \textbf{LLM-as-Judge-Verfahren} (Zheng et al.~2023) bewertet KI-generierte Ausgaben automatisiert durch ein vom generierenden Modell verschiedenes Sprachmodell entlang definierter Qualitätsdimensionen. Es ermöglicht skalierbare Qualitätsbewertungen ohne menschliche Annotationskosten und zeigt in Korrelationsstudien eine moderate Übereinstimmung mit menschlichen Urteilen (vgl. Zheng et al.~2023, S.~8).
