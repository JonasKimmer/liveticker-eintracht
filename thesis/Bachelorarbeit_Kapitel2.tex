...
Diese Defizite spiegeln die drei in Abschnitt~\ref{problemstellung-und-zielsetzung} identifizierten Anforderungsdimensionen direkt wider: operativer Zeitdruck durch vollständig manuelle Produktion, fehlende Mehrsprachigkeit und eingeschränkte White-Label-Fähigkeit. Das in dieser Arbeit entwickelte System adressiert alle sechs Punkte, wie die Systemkonzeption (Kapitel~\ref{systemkonzeption}) und der Anforderungsabgleich (Abschnitt~\ref{anforderungsabgleich-soll-ist-vergleich}) im Detail zeigen.
...
\bottomrule\noalign{}
\endlastfoot
A1 & Schichtenbasierte Systemarchitektur mit klar getrennten Verantwortlichkeiten & Kap.~\ref{redaktioneller-aufwand-bei-livetickern}, \ref{white-label-bedarf-im-profisport} (Modularität) \\
