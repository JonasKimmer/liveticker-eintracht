...
Dieser Abschnitt beschreibt die vereinsspezifischen Betriebskennzahlen (Abschnitt~\ref{fallstudie-eintracht-frankfurt}) sowie den Ist-Zustand des bestehenden Redaktionssystems auf Basis eines leitfadengestützten Experteninterviews mit dem Digitalverantwortlichen des Vereins (Abschnitt~\ref{ist-zustand-bestehendes-system}).
