...
def upgrade() -> None:
    ...
    op.drop_index('ix_style_references_event_type', table_name='style_references')
    op.drop_index('ix_style_references_event_type_instance', table_name='style_references')
    op.drop_index('ix_style_references_instance', table_name='style_references')
    ...
    op.drop_index('idx_media_queue_created_at', table_name='media_queue')
    op.drop_index('idx_media_queue_status', table_name='media_queue')
