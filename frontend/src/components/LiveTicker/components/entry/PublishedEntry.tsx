...
function getMediaIcon(videoUrl: string | null | undefined, imageUrl: string | null | undefined, fallback: string) {
...
function getMediaLabel(videoUrl: string | null | undefined, imageUrl: string | null | undefined) {
