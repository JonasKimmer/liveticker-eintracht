...
export function SummaryRow({ draft, label, isSelected, onSelect, onReject }) {
      ...
      <div className="lt-event-card__row">
        ...
        {!confirmReject && (
          <button
            ...
            style={{
              ...
              border: "none", color: "var(--lt-text-faint)", cursor: "pointer",
              fontSize: "0.75rem", padding: "0 2px", opacity: 0.5,
            }}
          >
            ✕
          </button>
        ...
        {confirmReject && (
          ...
          >
            ...
            <button
              style={{
                fontSize: "0.7rem", padding: "1px 6px", background: "none",
