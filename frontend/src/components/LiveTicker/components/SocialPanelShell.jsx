// ============================================================
// SocialPanelShell.jsx
// Wiederverwendbarer Rahmen für Social-Media-Panels.
// Kapselt: Collapsible-Header, Status-Meldung, Import/Refresh-
// Buttons, Lade- und Leer-Zustand sowie das Content-Grid.
// Platform-spezifisches Verhalten (Icon, Farben, Karten) wird
...
StatusMessage.propTypes = {
  msg: PropTypes.shape({ type: PropTypes.string, text: PropTypes.string }),
};
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
            <button
              ...
              style={{
                ...
                borderRadius: 6,
                border: "none",
                background: importing ? "var(--lt-bg-card-2)" : importBackground,
            ...
            >
              {importing ? "Importiert…" : importLabel}
            </button>
            <button
              onClick={onRefresh}
              disabled={loading}
          ...
          {!loading && badgeCount > 0 && (
            <>
              ...
              <div style={{ display: "grid", gridTemplateColumns: gridColumns, gap: "0.4rem" }}>
                {children}
              </div>
            </>
          )}
...
SocialPanelShell.propTypes = {
  open: PropTypes.bool.isRequired,
  onToggle: PropTypes.func.isRequired,
  icon: PropTypes.node.isRequired,
  label: PropTypes.string.isRequired,
  badgeCount: PropTypes.number.isRequired,
  badgeBackground: PropTypes.string.isRequired,
  importing: PropTypes.bool.isRequired,
  loading: PropTypes.bool.isRequired,
  onImport: PropTypes.func.isRequired,
  onRefresh: PropTypes.func.isRequired,
  importLabel: PropTypes.string.isRequired,
  importBackground: PropTypes.string.isRequired,
  emptyLabel: PropTypes.string.isRequired,
  hintLabel: PropTypes.string,
  statusMsg: PropTypes.shape({ type: PropTypes.string, text: PropTypes.string }),
