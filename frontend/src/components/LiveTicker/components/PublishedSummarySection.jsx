 ...
 */
export function PublishedSummarySection({ onRetract }) {
  ...
  return (
    <CollapsibleSection title="Veröffentlicht" count={published.length} defaultOpen={false}>
      {published.map((entry) => {
...
PublishedSummarySection.propTypes = {
