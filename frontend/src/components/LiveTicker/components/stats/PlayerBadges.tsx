...
export const PlayerBadges = memo(function PlayerBadges({
  ...
  return (
    <span className="lt-lineup-badges">
      ...
      {subOff && (
        <span
          className="lt-lineup-badge lt-lineup-badge--out"
          title="Ausgewechselt"
        >
          ↓{subOffMin ? `${subOffMin}'` : ""}
        </span>
      ...
      {subOn && (
        <span
          className="lt-lineup-badge lt-lineup-badge--in"
          title="Eingewechselt"
        >
          ↑{subOnMin ? `${subOnMin}'` : ""}
        </span>
