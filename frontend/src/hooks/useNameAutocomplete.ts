 ...
 */
export function useNameAutocomplete(value: string, playerNames: string[], { showPalette = false, onReplace, inputRef }: { showPalette?: boolean; onReplace?: (v: string) => void; inputRef?: React.RefObject<HTMLElement> } = {}) {
  ...
  return { lastWord, nameSuggestions, showNames, nameIdx, setNameIdx, selectName };
}
